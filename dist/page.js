...
var Test;
(function(Test2) {
  Test2[Test2["测试"] = 123] = "测试";
})(Test || (Test = {}));

// src/page.tsx
const react = __toModule(require_react());
const react_dom = __toModule(require_react_dom());
class Page extends react.default.Component {
  render() {
    var _a, _b;
    const a = {};
    const c = (_b = (_a = a == null ? void 0 : a.name) == null ? void 0 : _a.abc) != null ? _b : "";
...
react_dom.default.render(/* @__PURE__ */ react.default.createElement(Page, null), document.getElementById("root"));
